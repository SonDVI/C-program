...
bool cmp(Student x, Student y) {
    if(stoi(x.getdate().year) != stoi(y.getdate().year)) return stoi(x.getdate().year) < stoi(y.getdate().year);
    else if(stoi(x.getdate().month) != stoi(y.getdate().month)) return stoi(x.getdate().month) < stoi(y.getdate().month);
    else if(stoi(x.getdate().day) != stoi(y.getdate().day)) return stoi(x.getdate().day) < stoi(y.getdate().day);
