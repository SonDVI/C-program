...
/*Bạn hãy liệt kê những sinh viên trong danh sách này có điểm gpa >= 2.5 để xét tốt nghiệp, mỗi sinh viên được in thông tin trên 1 dòng.
...
int main() {
    ...
    while(n != 0) {
        ...
        if(gpa >= 2.5) cout << sinhvien.tostring() << endl;
        --n;
    }   
    return 0;
}
