...
int main() {
    ...
    while(n != 0) {
        ...
        if(stoi(sinhvien.getdate().year) < 2002) cout << sinhvien.tostring() << endl;
        else if (stoi(sinhvien.getdate().month) < 7 && stoi(sinhvien.getdate().year) == 2002) cout << sinhvien.tostring() << endl;
        else if(stoi(sinhvien.getdate().day) < 30 && stoi(sinhvien.getdate().year) == 2002 && stoi(sinhvien.getdate().month) == 7) cout << sinhvien.tostring() << endl;
        --n;
    }
